...
export default function Sidebar({ showSidebar }: Props) {
  ...
  return (
    <SidebarDiv showSidebar={showSidebar} isSmallScreen={isSmallScreen}>
...
const SidebarDiv = styled.div<{ showSidebar: boolean; isSmallScreen: boolean }>`
  max-width: ${({ isSmallScreen }) => (isSmallScreen ? "30%" : "100%")};
