        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntryIsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactPersonFirstName = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ContactPersonLastName = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ContactPersonMail = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    EntryIsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDefinition = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    UserRegionId = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    EntryIsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
